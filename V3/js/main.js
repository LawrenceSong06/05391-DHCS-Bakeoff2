...
class PivotRect extends Shape {
    ...
    bind_pivots_to(svg, rect) {
        ...
        const pivot3 = center.add(center.subtract(pivot1).rotate(-Math.PI / 2));
        const pivot4 = center.add(center.subtract(pivot1).rotate(Math.PI / 2));
...
window.addEventListener("load", (e) => {
    ...
    const trial = new Trial(tasksLength, "JoshLawrenceManyaNandini", true);
